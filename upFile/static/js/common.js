let reg = /^(https?:\/\/)([^\/#]+)/,
  serverURL = window.location.href.match(reg)[0];
// 本地储存
...
~function () {
  ...
  `
  function change() {
    img.src = `/img/loading${randomNum(5, 22)}.gif`
  }
  change()
